...
--
-- Name: associate_stations; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE associate_stations FROM PUBLIC;
REVOKE ALL ON TABLE associate_stations FROM postgres;
GRANT ALL ON TABLE associate_stations TO postgres;
GRANT SELECT,INSERT,DELETE,TRUNCATE,UPDATE ON TABLE associate_stations TO jp_readwrite;
...
--
-- Name: pickup_sub_tasks; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE pickup_sub_tasks FROM PUBLIC;
REVOKE ALL ON TABLE pickup_sub_tasks FROM postgres;
GRANT ALL ON TABLE pickup_sub_tasks TO postgres;
GRANT SELECT,INSERT,DELETE,TRUNCATE,UPDATE ON TABLE pickup_sub_tasks TO jp_readwrite;
